            ...
            <div class="container-fluid" >
              ...
              <div class="collapse navbar-collapse" id="navbarNav"style=" align-items: center;">
                <ul class="navbar-nav me-auto" style="align-items: center;margin: 0;">
                  ...
                  <li class="nav-item ">
                      <a class="nav-link"  id="home"href="index.html">Indoor Plants</a>
                    </li>
                    <li class="nav-item ">
                      <a class="nav-link"  id="home"href="index.html"> Outdoor Plants</a>
                    </li>
                    <li class="nav-item ">
                      <a class="nav-link"  id="home"href="index.html">Agricultural Supplies</a>
                    </li>
                  <li class="nav-item">
