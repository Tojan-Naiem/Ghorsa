...
<div class=" col-sm-10 col-xs-10" style="margin-left=50px">
  <div class="row">
    ...
    >
      <div class="mb-3" style="display: block; width: fit-content">
        <h6>Frame</h6>
        <img src="img/022462187b7b2dab43ed95bab6b24a66.png" alt="" /> <br />
        <label for="plant_image" class="form-label" style="margin-left: 30px"
          >Upload Image</label
        >
        <input
          type="file"
      ...
      <form id="plantForm">
        ...
        <div class="mb-3">
          <input
            ...
            class="form-control"
            id="color"
            placeholder="Enter Color Of Pot "
            required
        ...
        <div class="mb-3">
          <textarea
            ...
            rows="4"
            id="plantCare"
            placeholder="Enter How to Care Of Plant"
            style="box-shadow: none"
          ></textarea>
        </div>
